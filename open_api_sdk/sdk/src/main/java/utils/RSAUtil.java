...
public class RSAUtil {
    ...
    //私钥加密
    public static byte[] privateEncrypt(String content, String privateKeyString) throws Exception{
        PrivateKey privateKey = string2PrivateKey(privateKeyString);
        return privateEncrypt(content.getBytes(), privateKey);
    }
    ...
    public static String decryptByPubKey(String publicKey, String data) {
        try {
            return new String(publicDecrypt(base642Byte(data), publicKey));
        }catch (Exception e){
...
//            System.out.println("RSA私钥Base64编码:" + privateKeyStr);
    ...
    public void test4(){
        try {
            ...
            byte[] bytes1 = privateEncrypt(JSON.toJSONString(dto), PRIVATE_KEY);
            String s = byte2Base64(bytes1);
            System.out.println(s);
            String s1 = decryptByPubKey(PUBLIC_KEY_STRING, s);
