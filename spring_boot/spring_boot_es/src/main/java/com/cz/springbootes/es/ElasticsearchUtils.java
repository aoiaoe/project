...
public class ElasticsearchUtils {
    ...
    public static List<? extends Terms.Bucket> aggTerms(RestHighLevelClient client, String index,
        ...
        return aggTerms(client, index, aggregationBuilder, null, null);
    }
    ...
    public static List<? extends Terms.Bucket> aggTerms(RestHighLevelClient client, String index,
                                                        AggregationBuilder aggregationBuilder,
                                                        QueryBuilder queryBuilder) {
        return aggTerms(client, index, aggregationBuilder, queryBuilder, null);
    }
	 ...
	 * @param aggregationBuilder
	 * @param queryBuilder
	 * @param runtimeMapping 运行时映射
	 * @return
	 */
    public static List<? extends Terms.Bucket> aggTerms(RestHighLevelClient client, String index,
                                                        AggregationBuilder aggregationBuilder,
                                                        QueryBuilder queryBuilder,
                                                        Map<String, Object> runtimeMapping) {
        SearchSourceBuilder searchSourceBuilder = new SearchSourceBuilder();

        if (Objects.nonNull(queryBuilder)) {
            searchSourceBuilder.query(queryBuilder);
        }
        if (runtimeMapping != null && !runtimeMapping.isEmpty()) {
            searchSourceBuilder.runtimeMappings(runtimeMapping);
        }
